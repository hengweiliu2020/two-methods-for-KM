...
proc import datafile="D:\Clinical_Data\NGM438\NGM438-IO-101\final\prod\program\figure\data1.xlsx"
...
ods escapechar="~";
ods rtf file= "D:\Clinical_Data\NGM438\NGM438-IO-101\final\prod\program\figure\base model.rtf" nogtitle nogfootnote style=NGMStyle;
	...
	title1 font='Arial'  j=left "NGM Biopharmaceuticals, Inc."  j=right "Page ~{pageof}";
		...
		title3 font='Arial'  j=center "Figure 1: Mean ELF Change from Baseline with 95% CI over Visit";
		title4 font='Arial'  j=center "Base Model";
	
		footnote1 justify=l "~R'\brdrt\brdrs\brdrw5'";

		footnote2 font='Arial'  j=left "Program: base model.sas, generated at &sysdate &systime";
	run;
